...
Zilla implements the RESTful APIs defined in the [openapi](#openapi-client) binding. A REST Kafka proxy is defined using the [openapi-asyncapi](./openapi-asyncapi.md#openapi-asyncapi) binding. The Kafka configuration is defined with an [asyncapi](./asyncapi/#asyncapi-client) `client` binding.
