              ...
              children: [
                {
                  ...
                  children: [
                    "create-vpc.md",
                    "launch-ec2-instance.md",
                    "create-msk-cluster.md",
                    "create-certificate-authority-acm.md",
                    "create-client-certificate-acm.md",
                    "create-iam-role.md",
                    "create-key-pair.md",
                    "create-server-certificate-acm.md",
                    "create-server-certificate-letsencrypt.md",
                    "lookup-msk-server-names.md",
                    "manage-cloudformation-stack.md",
                    "troubleshooting.md"
                  ],
                },
              ],
