...
# Adding Zilla logs and metrics via the OpenTelemetry Protocol

In this guide, you run the [aklivity/open] and use Zilla to mediate MQTT broker messages onto those topics.
