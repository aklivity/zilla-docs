...
4. The Zilla Plus for Amazon MSK verified the client identity of the Kafka client
5. The Zilla Plus for Amazon MSK selected a matching client certificate to propagate client identity
6. The Zilla Plus for Amazon MSK routed the request to the appropriate MSK broker
