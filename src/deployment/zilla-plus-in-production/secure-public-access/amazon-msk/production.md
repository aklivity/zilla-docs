...
- *Configuration Reference
  ...
  3. This is the ARN of the created secret for the signed certificate's private key that was returned in the last step of the [Create Server Certificate (LetsEncrypt)](/resources/aws/create-server-certificate-letsencrypt.md) guide.
...
3. The Network Load Balancer forwarded the request to the Zilla Plus proxy
4. The Zilla Plus proxy routed the request to the appropriate MSK broker
