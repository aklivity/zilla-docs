...
- *Configuration Reference
  ...
  3. This is the ARN of the created secret for the signed certificate's private key that was returned in the last step of the [Create Server Certificate](/solutions/how-tos/aws-services/create-server-certificate-acm.md#store-the-encrypted-secret) guide.
