...
## Step 4: Verify <ZillaPlus/> proxy Service
...
2. With the Kafka client now installed we are ready to configure it and point it at the <ZillaPlus/> proxy.
...
Follow the [Monitoring the <ZillaPlus/> proxy](../other-resources/aws.md#aws) instructions

:::

::: info Upgrade the <ZillaPlus/> proxy

Follow the [Upgrading the <ZillaPlus/> proxy](../other-resources/aws.md#aws) instructions
