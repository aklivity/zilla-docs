...
Make sure to [attach the Internet Gateway](../resources/aws/create-vpc.md#attach-the-internet-gateway) and [route to the Internet Gateway](../resources/aws/create-vpc.md#route-to-the-internet-gateway), then try again.
...
- Zilla proxy
  - [via SASL/SCRAM](../deployment/zilla-plus-in-production/secure-public-access/amazon-msk/development.md#create-the-zilla-plus-proxy-iam-security-role)
  - [via mTLS](../deployment/zilla-plus-in-production/secure-public-access/amazon-msk/production.md#create-the-zilla-plus-proxy-iam-security-role)
  - [via Unauthorized access)](../deployment/zilla-plus-in-production/secure-public-access/amazon-msk/production-mutual-tls.md#create-the-zilla-plus-proxy-iam-security-role)
...
Note: if you followed [Create Server Certificate](../resources/aws/create-server-certificate-acm.md) to create the server certificate instead of [Create Server Certificate (LetsEncrypt)](../resources/aws/create-server-certificate-letsencrypt.md), then you will need to [Export the CA Certificate](../resources/aws/create-certificate-authority-acm.md#export-the-ca-certificate) and have `openssl` trust the exported CA certificate.
